...
export interface IngestFileRequest {
    ...
    /**
     * Defines a string which identifies the source of any records in the file. This could be the original filename or the name of the originating data source. 
     * @type {string}
     * @memberof IngestFileRequest
     */
    recordSource?: string;
...
export enum IngestFileRequestFileTypeEnum {
    ...
    DocumentPng = 'document.png',
    DocumentJpg = 'document.jpg'
}
